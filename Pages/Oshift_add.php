    ...
    <div class="container-fluid fl">
        ...
        <form action="Oshift_db.php" method="post" autocomplete="off">
            <div class="row mb-3">
                ...
                <div class="col-auto p-0"> <a type="" class="btn  rounded-pill btn-secondary " href="othershift.php">Back</a></div>
            </div>
                ...
                <div class="row px-2">
                    ...
                    <label class="form-label col-lg-3 col-md-6" for="stype">Type
                        ...
                        <?php
                            ...
                            ?>
                                 <option value="<?php echo $row1['workdet'] ?>" ><?php echo $row1['workdet'] ?></option>
                            <!-- <option value="MP">Manpower</option>
                            <option value="DW">Drum/Wrapping</option> -->
                            <?php } ?>
                        </select>
                    </label>
                    ...
                    <label  class="form-label col-lg-3 col-md-6" for="mp">M.P
                        <input class="form-control" type="text" id="mp" name="mp" value="0" >
                    </label>
  
                    <label  class="form-label col-lg-3 col-md-6" for="work">Work
                        <input class="form-control" type="text" id="work" name="work"  >
                    </label>
...
<script>
        ...
        $(document).on("change",".twt,.rate",function(){
