...
<div>
    ...
    <table class="table table-bordered text-center" id="summtable">
       ...
       <?php
        ...
        $str="-SERIES";
        $sql10="SELECT name,rate FROM  drum_series WHERE isDelete=0 ";
    ...
    //    for($i=0;$i<8;$i++){
       ...
       <tr>
            ...
            <?php 
            $sql="SELECT count(Drum_No) as cn FROM Dshift WHERE format(Date,'yyyy-MM')='$month' AND Drum_series='".$row10['name'] ."' "; 
            ...
            <td><input type="number" class="aamt"  name="amt[]" value="<?php echo $row10['rate'] *$row['cn']  ?>"readonly></td>
       </tr>
        <?php
        }  ?>
       <tr>
