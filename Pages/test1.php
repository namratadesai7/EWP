     ...
     $('#sdata').addClass('active');
        ...
        $(document).ready(function() {
            ...
            $('#addRowBtn').on('click', function() {
                ...
                const newRow = $('<tr>');
                newRow.html(' <td><input  type="text" class="type" name="type[]" value="Other"></td> <td> <select class="name" name="name[]" required><option value="">--Select--</option><option value="Bare Cu">Bare Cu</option><option value="Tin Cu">Tin Cu</option><option value="Alu">Alu</option><option value="PVC">PVC</option><option value="XLPE">XLPE</option><option value="GI">GI</option><option value="Tape">Tape</option><option value="PVC-D(RE-OUT)">PVC-D(RE-OUT)</option></select></td> <td><input type="text" class="rem" name="rem[]"></td> <td><input class="qty" type="number" name="qty[]"></td> <td><input class="rate" type="number" name="rate[]" value="0"></td> <td><input class="amt" type="number" name="amt[]" readonly></td>,<td><button class="btn-sm btn-danger remove-row" >X</button></td>');
