...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT into drum_material (id,name,rate,isDelete,createdBy) values ('$id', '$name','$rate','0','$user')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE drum_material SET name='$editName' ,rate='$editRate', updatedBy='$user' , updatedAt='$cur_date' where id='$editId'";
