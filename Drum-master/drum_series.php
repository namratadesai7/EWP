...
// Read Drum Series No Data from Database
$sql = "SELECT * FROM drum_series where isDelete = '0'";
...
<body>
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col">
                <h4 class="pt-2 mb-0">Drum Series</h4>
            </div>
            <div class="col-auto">
                    ...
                    <?php while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                        <tr>
                            ...
                            <td class="tdCss">
                                ...
                                <a href="drum_series_db.php?deleteid=<?php echo $row['id'] ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Drum Series No</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="modal-body" id="addForm" action="drum_series_db.php" method="post">
                    <div class="mb-3">
                        <label for="name">Drum Series No</label>
                        <input type="text" name="name" id="name" placeholder="Enter Drum Series No" class="form-control" required>
                    </div>
                    <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Drum Series No</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="modal-body" id="editForm" action="drum_series_db.php" method="post">
                    <input type="hidden" id="editId" name="editId">
                    <div class="mb-3">
                        <label for="name">Series No</label>
