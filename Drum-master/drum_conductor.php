...
// Read Conductor Data from Database
$sql = "SELECT * FROM drum_conductor where isDelete = '0'";
                    ...
                    <?php while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) { ?>
                        <tr>
                            ...
                            <td class="tdCss">
                                ...
                                <a href="drum_conductor_db.php?deleteid=<?php echo $row['id'] ?>"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="modal-body" id="addForm" action="drum_conductor_db.php" method="post">
                    <label for="name">Conductor Name</label>
                    <input type="text" name="name" id="name" placeholder="Enter Conductor" class="form-control" required>
                </form>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="modal-body" id="editForm" action="drum_conductor_db.php" method="post">
