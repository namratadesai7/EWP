...
?>
    ...
    ?>
        <tr >
            <td colspan="2"></td>
            <td class="totcol"> <input type="number"  step="0.01"  id="etqty" name="etqty" class="tqty" value="<?php echo $etqty ?>" readonly></td>
            <td></td>
            <td class="totcol"><input type="number"  step="0.01"  id="etamt" name="etamt" class="tamt4" value="<?php echo $etamt ?>" readonly></td>
        </tr> 
